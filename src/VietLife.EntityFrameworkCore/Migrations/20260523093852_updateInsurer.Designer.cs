...
namespace VietLife.Migrations
{
    ...
    [Migration("20260523093852_updateInsurer")]
    partial class updateInsurer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VietLife.TuongTac.Insurer.BaiViet", b =>
                {
                    ...
                    b.ToTable("AppBaiViets", (string)null);
                });
            ...
            modelBuilder.Entity("VietLife.TuongTac.Insurer.DangKyTuVan", b =>
                {
                    ...
                    b.ToTable("AppDangKyTuVans", (string)null);
                });

            modelBuilder.Entity("VietLife.TuongTac.Insurer.DanhMuc", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AnhMenu")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.ToTable("AppDanhMucs", (string)null);
                });
            ...
            modelBuilder.Entity("VietLife.TuongTac.Insurer.Nhom", b =>
                {
                    ...
                    b.HasIndex("DanhMucId", "Slug")
                        .IsUnique();

                    b.ToTable("AppNhoms", (string)null);
                });

            modelBuilder.Entity("VietLife.TuongTac.Insurer.SanPhamInsurer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VietLife.TuongTac.LienHes.LienHe", b =>
                {
                    ...
                    b.Property<string>("TuVan")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("AppLienHes", (string)null);
                });

            modelBuilder.Entity("VietLife.TuongTac.TinTucs.TinTuc", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTinTucs", (string)null);
                });
