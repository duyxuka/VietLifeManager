...
namespace VietLife.Migrations
{
    ...
    [Migration("20251014084011_UpdateQuanlynhansu")]
    partial class UpdateQuanlynhansu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VietLife.LoaiNghis.LoaiNghi", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppLoaiNghis", (string)null);
                });
            ...
            modelBuilder.Entity("VietLife.NghiPheps.NghiPhep", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LoaiNghiId");

                    b.HasIndex("NhanVienId");

                    b.ToTable("AppNghiPheps", (string)null);
                });
            ...
            modelBuilder.Entity("VietLife.NhanViens.NhanVien", b =>
                {
                    ...
                    b.ToTable("AppNhanViens", (string)null);
                });
            ...
            modelBuilder.Entity("VietLife.NghiPheps.NghiPhep", b =>
                {
                    b.HasOne("VietLife.LoaiNghis.LoaiNghi", "LoaiNghi")
                        .WithMany("NghiPheps")
                        .HasForeignKey("LoaiNghiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VietLife.NhanViens.NhanVien", b =>
                {
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("VietLife.NhanViens.NhanVien", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
