...
namespace VietLife.Catalog.Products
{
        ...
        IProductsAppService
    {
        ...
        public ProductsAppService(IRepository<Product, Guid> repository,
            ...
            IRepository<ProductAttributeVarchar> productAttributeVarcharRepository) : base(repository)
        {
        ...
        public async Task<string> GetThumbnailImageAsync(string fileName)
        {
            ...
            if (thumbnailContent is null)
                return null;
            string result = Convert.ToBase64String(thumbnailContent);
            return result;
        }
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(VietLifeDomainErrorCodes.ProductAttributeIdIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(VietLifeDomainErrorCodes.ProductAttributeValueIsNotValid);
                    }
