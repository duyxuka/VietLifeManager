...
namespace VietLife.TuongTac.Insurers
{
        ...
        ISeoConfigAppService
    {
            ...
            : base(repository)
        {
            ...
            GetPolicyName = VietLifePermissions.SeoConfig.View;           // cần tạo permission này
            GetListPolicyName = VietLifePermissions.SeoConfig.View;
            CreatePolicyName = VietLifePermissions.SeoConfig.Create;
            UpdatePolicyName = VietLifePermissions.SeoConfig.Update;
            DeletePolicyName = VietLifePermissions.SeoConfig.Delete;
        }
        ...
        [Authorize(VietLifePermissions.SeoConfig.View)]
        ...
        // ====================== CREATE ======================
        [Authorize(VietLifePermissions.SeoConfig.Create)]
        ...
        // ====================== UPDATE ======================
        [Authorize(VietLifePermissions.SeoConfig.Update)]
        ...
        // ====================== DELETE MULTIPLE ======================
        [Authorize(VietLifePermissions.SeoConfig.Delete)]
