...
import { ProductAttributeDto, ProductAttributesService } from '@proxy/viet-life/catalog/product-attributes';
import { attributeTypeOptions } from '@proxy/viet-life/product-attributes';
